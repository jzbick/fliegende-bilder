...
public interface BeyondarObjectPlugin extends Plugin {
     ...
     * {@link BeyondarObject BeyondarObject} is
     * changed.
     *
     ...
     * {@link BeyondarObject BeyondarObject} has
     * changed.
     *
     ...
     * Texture}1 of the {@link BeyondarObject
     ...
     * Renderable} of the {@link BeyondarObject
     * BeyondarObject} has been changed.
     *
    ...
    /**
     * Called when the {@link BeyondarObject
     * BeyondarObject} changes the value for facing the camera.
     *
     * @param faceToCamera True if it is facing to the camera, false otherwise.
     */
    ...
    /**
     * Get the {@link BeyondarObject BeyondarObject}
