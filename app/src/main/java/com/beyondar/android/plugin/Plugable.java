 ...
 *
 * @param <T> The type of plugin that the class can handle.
 */
public interface Plugable<T extends Plugin> {
     ...
     *
     * @param pluginClass The specific class that we want to retrieve
     * @param result      A list where all the plugins will be stored
     * @return
     */
