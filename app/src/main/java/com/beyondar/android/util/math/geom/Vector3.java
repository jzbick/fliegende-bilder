...
public class Vector3 extends Point3 {
     ...
     *
     * @param p1 Starting point for the vector
     * @param p2 Finish point for the vector
     */
     ...
     * @param normalize if the vector must be normalized after the addition
     */
     ...
     *
     * @param rotX rotation in radians
     */
     ...
     *
     * @param rotZ rotation in radians
     */
