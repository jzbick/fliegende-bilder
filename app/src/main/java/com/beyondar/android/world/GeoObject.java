...
/**
 * Extension of the {@link BeyondarObject BeyondarObject} to make easier the usage of geo
 * cordinates.
 */
public class GeoObject extends BeyondarObject {
    ...
    /**
     * Create an instance of a {@link GeoObject
     ...
     * {@link GeoObject GeoObject} unique id.
     */
    public GeoObject() {
        super();
        setVisible(true);
    ...
    /**
     * Set the position of the {@link GeoObject GeoObject}.
     *
     * @param latitude
     * @param longitude
     */
    ...
    /**
     * Calculate the distance of this {@link GeoObject GeoObject} from an other
     * {@link GeoObject GeoObject}.
     *
     * @param geo The other {@link GeoObject GeoObject} to calculate the distance.
     ...
     * {@link GeoObject GeoObject}.
     *
     * @param longitude The other {@link GeoObject GeoObject} longitude to calculate the
     *                  distance.
     * @param latitude  The other {@link GeoObject GeoObject} latitude to calculate the
     *                  distance.
     * @return The distance in meters.
     */
