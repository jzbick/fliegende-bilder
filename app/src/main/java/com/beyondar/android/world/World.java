 ...
 * {@link BeyondarObject BeyondarObject} to be
...
public class World implements Plugable<WorldPlugin> {
    ...
    /**
     * Remove a {@link BeyondarObject BeyondarObject}
     ...
     * {@link BeyondarObject BeyondarObject}.
     *
     * @param uri  The default image
     * @param type The type of the list to set the bitmap
     ...
     * {@link BeyondarObject BeyondarObject}.
     *
     * @param imageResource The default image reference.
     * @param type          The type of the list to set the image.
     ...
     * {@link BeyondarObject BeyondarObject} image is
     * not available.
     *
     * @param imageResId Default image.
     */
    ...
    /**
     * Get the {@link BeyondarObjectList
     ...
     * {@link BeyondarObjectList BeyondarObjectList}
     * in the {@link World}
     *
    ...
    /**
     * Get all the {@link BeyondarObject
     * BeyondarObject} that collide with the {@link Ray}.
     *
     * @param ray                   The ray to use for the collision calculus
     * @param beyondarObjectsOutput The {@link ArrayList} that will store the objects sorted by
     *                              proximity. This list will be cleaned before.
     * @param maxDistance           Max distance to consider if a {@link BeyondarObject} can
     *                              collide (in meters).
     */
